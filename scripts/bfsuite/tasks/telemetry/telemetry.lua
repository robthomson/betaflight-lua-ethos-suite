...
local sensorTable = {}
sensorTable["rssi"] = {sport = bfsuite.utils.getRssiSensor(), ccrsf = bfsuite.utils.getRssiSensor(), bfsuite.utils.getRssiSensor()}
...
function telemetry.wakeup()
    ...
    if bfsuite.app.triggers.mspBusy ~= true then
        local now = os.clock()
    ...
    if not telemetry.active() or bfsuite.rssiSensorChanged == true then
        telemetrySOURCE = nil
        crsfSOURCE = nil
        protocol = nil
        sensors = {}
