...
if bfsuite.RateTable == nil then bfsuite.RateTable = bfsuite.config.defaultRateProfile end
...
local function preSavePayload(payload)
    if bfsuite.app.triggers.resetRates == true then
        bfsuite.app.triggers.resetRates = false
        bfsuite.NewRateTable = bfsuite.app.Page.values[1]
        payload = defaultRates(bfsuite.NewRateTable)
    end
