...
local function wakeup()
    ...
    if triggerSave == true then
        bfsuite.app.ui.progressDisplaySave()
    ...
    if triggerSaveCounter == true then
        ...
        bfsuite.app.ui.progressDisplaySaveValue(saveCounter, message)
        if saveCounter >= 100 then
            saveCounter = 0
            triggerSaveCounter = false
            bfsuite.app.dialogs.saveDisplay = false
            bfsuite.app.ui.progressDisplaySaveClose()
    ...
    if triggerMSPWrite == true then
        ...
        local profileIndex = bfsuite.app.Page.fields[1].value
        local rateIndex = bfsuite.app.Page.fields[2].value
