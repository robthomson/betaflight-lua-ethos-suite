...
local folder = "scorp"
local ESC = assert(compile.loadScript(bfsuite.config.suiteDir .. "app/pages/esc/" .. folder .. "/init.lua"))()
...
local function onNavMenu(self)
    bfsuite.app.triggers.escToolEnableButtons = true
...
return {
    ...
    headerLine = bfsuite.escHeaderLineText
}
