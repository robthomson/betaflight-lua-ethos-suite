...
-- fc rate
fields[#fields + 1] = {row = 1, col = 2, min = 0, max = 99, vals = {3}, default = 0, decimals = 2, scale = 100}
fields[#fields + 1] = {row = 2, col = 2, min = 0, max = 99, vals = {4}, default = 0, decimals = 2, scale = 100}
fields[#fields + 1] = {row = 3, col = 2, min = 0, max = 99, vals = {5}, default = 0, decimals = 2, scale = 100}
